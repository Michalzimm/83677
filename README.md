...
* The computational graph currently runs utilizing active functional pipelines governed by addition and increment processing nodes (PlusAgent and IncAgent).
